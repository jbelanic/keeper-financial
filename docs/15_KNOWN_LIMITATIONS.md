...
- Key custody/recovery owners, legal-hold authority, public DNS/TLS ceremony, Caddy configuration, backup/restore/purge drill, monitoring/incident response, and public abuse capacity remain operational evidence items during deployment execution rather than missing owner-approval blockers.
